...
final class CanAssignCaseSpecification implements Specification
{
    public function isSatisfiedBy(object $candidate): bool
    {
        ...
        return $candidate->status === Approved::getMorphClass();
    }

    public function getErrorMessage(): string
    {
        return 'Only approved cases can be assigned.';
    }
}
